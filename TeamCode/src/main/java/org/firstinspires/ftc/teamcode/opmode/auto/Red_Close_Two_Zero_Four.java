...
public class Red_Close_Two_Zero_Four extends OpMode {
    ...
    public void setBackdropGoalPose() {
        switch (navigation) {
            ...
            case "left":
                ...
                firstCycleBackdropGoalPose = new Pose(WhiteBackstage.getX(), WhiteBackstage.getY(), Math.toRadians(90));
    ...
    public void buildPaths() {
        ...
        cycleStackBackBezier = follower.pathBuilder()
                ...
                .setConstantHeadingInterpolation(WhiteBackstage.getHeading())
                .addPath(new BezierCurve(new Point(BottomTruss), new Point(13+14, 130.8, Point.CARTESIAN), new Point(30+14,91.6, Point.CARTESIAN), new Point(WhiteBackstage)))
                .setConstantHeadingInterpolation(WhiteBackstage.getHeading())
                .setPathEndTimeoutConstraint(0)
                .build();
    }
